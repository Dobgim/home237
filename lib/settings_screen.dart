            ...
            _buildSettingsCard(children: [
              ...
              if (authService.userRole == UserRole.admin)
                _buildSettingsTile(
                  ...
                  title: 'Admin Payout Settings',
                  subtitle: 'Configure fee payout number',
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const AdminFeeSettingsScreen()),
                    );
                  },
                ),
            ]),
