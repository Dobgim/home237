                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return t.get('err_name_empty'); // Or company name required
                        }
                        return null;
                      },
                    ),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: t.get('business_email'),
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return t.get('err_email_empty');
                        }
                        if (!value.contains('@')) {
                          return t.get('err_email_invalid');
                        }
                        return null;
                      },
                    ),
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setDialogState) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text(
                AppLocalizations.of(context).get('delete_warning_landlord'),
                style: TextStyle(
                  fontSize: 14,
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: const Icon(Icons.delete_forever_outlined, color: Colors.red),
                ),
                onChanged: (v) => setDialogState((){}), // Trigger rebuild to enable button
              ),
            ],
          ),
          actions: [
            ...
            ElevatedButton(
              onPressed: (isLoading || confirmCtrl.text.trim() != 'DELETE')
                  ? null
                  : () async {
                      setDialogState(() {
                        isLoading = true;
                      ...
                      try {
                        ...
                        if (e.toString().contains('requires-recent-login')) {
                          msg = 'For security reasons, please log out and log back in before deleting your account.';
                        }
                        setDialogState(() {
                          errorMessage = msg;
                          isLoading = false;
