...
class _OnboardingScreenState extends State<OnboardingScreen>
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Warning text
          Text(
            'To protect yourself from fraud, please follow these rules:',
            style: TextStyle(
              fontSize: 12.5,
          ...
          _safetyBullet(
            '🚫',
            'Never send money outside this app',
            isDark,
          ),
          _safetyBullet(
            '🚫',
            'Never pay via WhatsApp, calls, or bank transfer before touring',
            isDark,
          ),
          _safetyBullet(
            '✅',
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    'Home237 will NEVER ask you to pay outside the app.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 11.5,
                      fontWeight: FontWeight.bold,
                      color: isDark ? Colors.redAccent[100] : const Color(0xFFDC2626),
  ...
  Widget _safetyBullet(String emoji, String text, bool isDark) {
    return Padding(
